...
public/data/
├── images/
│   ├── kmeans_substation_clusters.png
│   ├── kmeans_substation_clusters_risk_shapes.png
│   └── kmeans_classified_substation_clusters.png
├── classified_risk_substations.txt
...
- `substation_sites_processed.geojson`: Generated by `scripts/process_substations.py`, contains processed substation data with flood risk analysis.
- `classified_risk_substations.txt`: Classified substations sorted by final risk score, generated by `scripts/export_risk_substations.py`.
- `sensitivity_results.txt`: Sensitivity analysis results for different weighting scenarios, generated by `scripts/sensitivity_analysis.py`.
- `substations_all.csv`: Full Microsoft Excel csv export of data processed during the project.
...
- To run the complete data processing pipeline locally, execute `scripts/main.py`, which sequentially runs all processing scripts and outputs results to `public/data/`.
